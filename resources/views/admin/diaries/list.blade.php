                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <button type="button" class="btn btn-primary"
                                onclick="window.location.href='{{ route('admin.diaries.view-store') }}'">
                                {{-- data-bs-toggle="modal" data-bs-target="#kt_modal_add_user" --}}

                                <i class="fas fa-plus"></i> Criar diário
                            </button>
                            <!--end::Add user-->
                        </div>
                        <!--end::Toolbar-->
...
@push('scripts')
    ...
    <script>
        ...
        let diaryCreated = '{{ session('diary_saved') ? '1' : '0' }}';
    ...
    <script src="/assets/js/custom/admin/diaries/list/table.js"></script>
