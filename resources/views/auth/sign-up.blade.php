...
<html lang="en">
	...
	<body id="kt_body" class="bg-body">
					...
					<div class="w-lg-600px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						...
						<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form">
							...
							<div class="mb-10 text-center">
								...
								<a href="{{route('auth.sign-in')}}" class="link-primary fw-bolder">Faça login</a></div>
								<!--end::Link-->
							</div>
							<!--end::Heading-->
							<!--begin::Action-->
							...
							<div class="row fv-row mb-7">
								...
								<div class="col-xl-6">
									...
									<input class="form-control form-control-lg form-control-solid" type="text" placeholder="" id="first_name" name="first-name" autocomplete="off" />
								</div>
								<!--end::Col-->
								<!--begin::Col-->
								<div class="col-xl-6">
									<label class="form-label fw-bolder text-dark fs-6">Sobrenome</label>
									<input class="form-control form-control-lg form-control-solid" type="text" placeholder="" id="last_name" name="last-name" autocomplete="off" />
								</div>
								<!--end::Col-->
							</div>
							<!--end::Input group-->
		...
		<script src="assets/plugins/custom/axios/axios.min.js"></script>
		<!--begin::Page Custom Javascript(used by this page)-->
		<script>
			let routeSignUp = "{{route('auth.sign-up')}}";
			let routeSignIn = "{{route('auth.sign-in')}}";
		</script>
