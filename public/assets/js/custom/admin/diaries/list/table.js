...
var KTUsersList = function () {
    ...
    return {
        init: function () {
            ...
            o && (o.querySelectorAll("tbody tr").forEach((e => {
            ...
            })), (diariesDatatable = $(o).DataTable({
                ajax: urlDiariesDatatable,
                info: !1,
                order: [],
                pageLength: 10,
                lengthChange: !1,
                columns: [
                    ...
                    },
                    {
                        ...
                        width: '10%',
                        render: function (id) {
                            return `<button onclick='excluir(${id})' class='btn btn-danger'> <i class='fas fa-trash'></i> </button>`;
                        }
                    },
                ],
                columnDefs: [
                ...
                diariesDatatable.search(t.target.value).draw()
            })), c(), (() => {
